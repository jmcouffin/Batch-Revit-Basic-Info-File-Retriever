    ...
    if path.exists(rvt_file): 
        if isOleFile(rvt_file): 
            ...
            if last_save_path:
                ...
                last_save_path_data = "Last Save Path: None"
            ...
            if open_workset_default:
                ...
                open_workset_default_data = "Open Workset Default: None"
            ...
            if project_spark_file:
                ...
                project_spark_file_data = "Project Spark File: None"
            ...
            if central_model_identity:
                ...
                central_model_identity_data = "Central Model Identity: None"
            ...
            if all_local_changes_saved_to_central:
                ...
                all_local_changes_saved_to_central_data = "All Local Changes Saved to Central: None"
            ...
            if central_model_version_number:
                ...
                central_model_version_number_data = "Central model's version number corresponding to the last reload latest: None"
            ...
            if central_model_episode:
                ...
                central_model_episode_data = "Central model's episode GUID corresponding to the last reload latest: None"
            ...
            if unique_document_guid:
                ...
                unique_document_guid_data = "Unique Document GUID: None"
            ...
            if issingleusercloudmodel:
                ...
                issingleusercloudmodel_data = "IsSingleUserCloudModel: None"
